...
$$
\begin{eqnarray}\frac{\unicode[STIX]{x1D70E}}{Da}m^{3}+\left(\unicode[STIX]{x1D70E}{\mathcal{K}}-\frac{n}{Da{\mathcal{S}}}\right)m^{2}-\left(\frac{n{\mathcal{K}}}{{\mathcal{S}}}+\frac{\unicode[STIX]{x1D70E}}{Da}k^{2}\right)m+\left(n-\unicode[STIX]{x1D70E}{\mathcal{K}}\right)k^{2}=0,\end{eqnarray}
$$
...
4. Put $$m_j$$ to  matrix eq(29) to get $$A_1$$,  $$A_2$$,  $$A_3$$, and have the expression of $$P_1$$ eq(23). 
